...
const updateDb = async function (callId, invitationId) {
    ...
    const res = mapping.map(el => model.insertFields(pool, argc.callId, argc.invitationId, el.callPhaseId, el.tableName1, el.tableName2, '', el.datafilter, el.name, el.label, el.etype))
